defmodule BunnehMQ.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      # Starts a worker by calling: BunnehMQ.Worker.start_link(arg1, arg2, arg3)
      # worker(BunnehMQ.Worker, [arg1, arg2, arg3]),
    ]

    # See http://elixir-lang.org/docs/stable/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: BunnehMQ.Supervisor]
